...
Got the idea from thekarangoel (see the project I forked this from).

Some details:

* I will use Lua to solve these because it is the language I'm interested in learning.
* I have no interest in making complete games, so I'm ignoring those.
...
**NOTE:** I'm also still learning how GitHub works, so apologies if anything seems messy here.
==============================
...
[**Pig Latin**](Text/piglatin.lua) – Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](Text/countvowels.lua) – Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](Text/checkifpalindrome.lua) – Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”
